G.AddData({
    ...
    func:function()
    {
        ...
        */
        ...
        {
            var str='Your name is '+G.getName('ruler')+''+(G.getName('ruler').toLowerCase()=='orteil'?' <i>(but that\'s not you, is it?)</i>':'')+', ruler of '+G.getName('civ')+'. Your tribe is primitive, but full of hope.<br>The first year of your legacy has begun. May it stand the test of time.e';
        ...
        {
            G.Message({type:'important tall',text:'Welcome back, '+G.getName('ruler')+', commander of '+G.getName('civ')+'. Hope you had a nice break :)',icon:[0,3]});
        }
        ...
        new G.Unit({
            name:'farm',
            desc:'@grows fresh [food], up to 20 per day<>The [farm] is a steady source of fresh fruits.',
            icon:[25,3],
            cost:{'stone':50,'archaic building materials':20},
            use:{'land':1},
            effects:[
                {type:'gather',what:{'fruit':20}},
            ],
            category:'production',
            req:{'well-digging':true},
            limitPer:{'land':10},
